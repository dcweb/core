    ...
    plugin.init = function() {
      ...
      .on( click_handler, 'span.swatch', function(e){ 
        ...
        var
          ...
          $periodID = $ (this).find('period-box').attr('id'),
          periodupdate = '',
          // Select all button in document with same data target to keep them synconized
          $button = $( this ).closest('.'+ns+'-button[data-target="' + $( this ).closest( '.'+ns+'-button' ).attr('data-target') + '"]'),
        ...
        $(this).closest('.period-box').find('.checkbox-group .swatch.active').each(function(){  
          periodupdate += $(this).attr('data-name');
          
        });
        
        
        $(this).closest('.period-box').find('.form-control').attr('value',periodupdate);
