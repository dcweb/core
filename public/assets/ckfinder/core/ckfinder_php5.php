...
class CKFinder
{
	...
	public function SetupFCKeditorObject( &$editorObj, $imageType = null, $flashType = null )
	{
		...
		$editorObj->Config['ImageBrowserURL'] = $url . $qs . 'type=' . ( empty( $imageType ) ? 'image' : $imageType ) ;
		...
		$editorObj->Config['ImageUploadURL'] = $dir . urlencode( 'core/connector/php/connector.php?command=QuickUpload&type=') . ( empty( $imageType ) ? 'image' : $imageType ) ;
	...
	public function SetupCKEditorObject( &$editorObj, $imageType = null, $flashType = null )
	{
		...
		$editorObj->config['filebrowserImageBrowseUrl'] = $url . $qs . 'type=' . ( empty( $imageType ) ? 'image' : $imageType ) ;
		...
		$editorObj->config['filebrowserImageUploadUrl'] = $dir . 'core/connector/php/connector.php?command=QuickUpload&type=' . ( empty( $imageType ) ? 'image' : $imageType ) ;
